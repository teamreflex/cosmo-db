module.exports = class Data1721359520021 {
  ...
  async up(db) {
    await db.query(
      `CREATE TABLE "objekt" ("id" character varying NOT NULL, "owner" text NOT NULL, "minted_at" TIMESTAMP WITH TIME ZONE NOT NULL, "received_at" TIMESTAMP WITH TIME ZONE NOT NULL, "serial" integer NOT NULL, "transferable" boolean NOT NULL, "collection_id" character varying, CONSTRAINT "PK_a50fda223abd7f6ae55f2cf629f" PRIMARY KEY ("id"))`
    );
    await db.query(
    ...
    await db.query(
      `CREATE TABLE "transfer" ("id" character varying NOT NULL, "from" text NOT NULL, "to" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "token_id" text NOT NULL, "hash" text NOT NULL, "objekt_id" character varying, "collection_id" character varying, CONSTRAINT "PK_fd9ddbdd49a17afcbe014401295" PRIMARY KEY ("id"))`
    );
    await db.query(
    ...
    await db.query(
      `CREATE TABLE "collection" ("id" character varying NOT NULL, "contract" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "slug" text NOT NULL, "collection_id" text NOT NULL, "season" text NOT NULL, "member" text NOT NULL, "artist" text NOT NULL, "collection_no" text NOT NULL, "class" text NOT NULL, "thumbnail_image" text NOT NULL, "front_image" text NOT NULL, "back_image" text NOT NULL, "background_color" text NOT NULL, "text_color" text NOT NULL, "accent_color" text NOT NULL, "como_amount" integer NOT NULL, "on_offline" text NOT NULL, CONSTRAINT "PK_ad3f485bbc99d875491f44d7c85" PRIMARY KEY ("id"))`
    );
    await db.query(
    ...
    await db.query(
      `CREATE TABLE "como_balance" ("id" character varying NOT NULL, "contract" text NOT NULL, "owner" text NOT NULL, "amount" numeric NOT NULL, CONSTRAINT "PK_965a782766b42e9c0cf627e9295" PRIMARY KEY ("id"))`
    );
    await db.query(
    ...
    await db.query(
      `CREATE TABLE "vote" ("id" character varying NOT NULL, "from" text NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL, "contract" text NOT NULL, "poll_id" integer NOT NULL, "candidate_id" integer, "index" integer NOT NULL, "amount" numeric NOT NULL, CONSTRAINT "PK_2d5932d46afe39c8176f9d4be72" PRIMARY KEY ("id"))`
    );
    await db.query(
