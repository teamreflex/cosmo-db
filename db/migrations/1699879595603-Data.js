module.exports = class Data1699879595603 {
  ...
  async up(db) {
    await db.query(
      `CREATE TABLE "objekt" ("id" text NOT NULL, "contract" text NOT NULL, "collection_id" text NOT NULL, "season" text NOT NULL, "member" text NOT NULL, "artist" text NOT NULL, "collection_no" text NOT NULL, "class" text NOT NULL, "front_image" text NOT NULL, "back_image" text NOT NULL, "background_color" text NOT NULL, "text_color" text NOT NULL, "como_amount" integer NOT NULL, "on_offline" text NOT NULL, CONSTRAINT "PK_a50fda223abd7f6ae55f2cf629f" PRIMARY KEY ("id"))`
    );
    await db.query(
      `CREATE INDEX "IDX_c7d721d66d18949694e136c473" ON "objekt" ("id") `
    );
    await db.query(
    ...
    await db.query(
      `CREATE TABLE "como_calendar" ("id" text NOT NULL, "contract" text NOT NULL, "address" text NOT NULL, "day" integer NOT NULL, "amount" integer NOT NULL, CONSTRAINT "PK_c7cd8ddc32f266bb7d4ebce879c" PRIMARY KEY ("id"))`
    );
    await db.query(
      `CREATE INDEX "IDX_d7b8549a8bde9aafebee36d8df" ON "como_calendar" ("id") `
    );
    await db.query(
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_c7d721d66d18949694e136c473"`);
    ...
    await db.query(`DROP INDEX "public"."IDX_d7b8549a8bde9aafebee36d8df"`);
