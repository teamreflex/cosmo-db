...
export const events = {
  Finalized: new LogEvent<
    [pollId: bigint, burned: bigint] & { pollId: bigint; burned: bigint }
  ...
  PollCreated: new LogEvent<[pollId: bigint] & { pollId: bigint }>(
    abi,
    "0xab0309b6731a34e8750174d3c2c9591a34a2bf0c1425a30b34122be08d050739"
  ),
  Revealed: new LogEvent<
    [pollId: bigint, revealedVotes: bigint, remainingVotes: bigint] & {
      pollId: bigint;
      revealedVotes: bigint;
      remainingVotes: bigint;
    }
  >(abi, "0x7162321ecace9c982905ec8d8000eb292887b6befedc98e18dbb27fa95e752d7"),
  RoleAdminChanged: new LogEvent<
...
export const functions = {
  DEFAULT_ADMIN_ROLE: new Func<[], {}, string>(abi, "0xa217fddf"),
  OPERATOR_ROLE: new Func<[], {}, string>(abi, "0xf5b541a6"),
  candidates: new Func<[pollId: bigint], { pollId: bigint }, Array<string>>(
    abi,
    "0x3477ee2e"
  ),
  comoContract: new Func<[], {}, string>(abi, "0xabfecc48"),
  createPoll: new Func<
    [
      title_: string,
  ...
  hasRole: new Func<
    ...
    boolean
  >(abi, "0x91d14854"),
  hashes: new Func<[_: bigint, _: string], {}, boolean>(abi, "0xe28f80ce"),
  initialize: new Func<
    [voteSignerAddress_: string, comoAddress_: string],
    { voteSignerAddress_: string; comoAddress_: string },
    []
  >(abi, "0x485cc955"),
  ...
  pollResult: new Func<
    ...
    { pollId: bigint },
    Array<
      [candidate: string, votes: bigint] & { candidate: string; votes: bigint }
    >
  >(abi, "0xa9448999"),
  polls: new Func<
    [_: bigint],
  ...
  reset: new Func<
    [
      pollId: bigint,
      missingOffset: bigint,
      missingCommitData: Array<
        [comoAmount: bigint, hash: string] & {
          comoAmount: bigint;
          hash: string;
        }
      >
  ...
  reveal: new Func<
    [
      pollId: bigint,
      data: Array<
        [votedCandidateId: bigint, salt: string] & {
  ...
  voteSignerAddress: new Func<[], {}, string>(abi, "0x525e70f6"),
  voters: new Func<[_: bigint, _: bigint], {}, string>(abi, "0xfba00cbd"),
  votes: new Func<
    [pollId: bigint],
    { pollId: bigint },
    Array<
      [comoAmount: bigint, hash: string] & { comoAmount: bigint; hash: string }
    >
  >(abi, "0x5df81330"),
  votesPerCandidates: new Func<
    [pollId: bigint],
    { pollId: bigint },
    Array<bigint>
  >(abi, "0x48267186"),
